    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form method="POST" action="{{url('/revoke_orders/'.$order->id.'/update')}}" role="form">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 row @if($errors->first('amount') != '') has-error @endif">
                                    ...
                                    <input id="amount" name="amount" value="{{$order->amount}}" type="text" class="form-control col-md-8">
                                ...
                                <div class="form-group col-md-6 row @if($errors->first('account_number') != '') has-error @endif">
                                    ...
                                    <input id="account_number" name="account_number" value="{{$order->account_number}}" type="text" class="form-control col-md-8">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 row @if($errors->first('bank') != '') has-error @endif">
                                    ...
                                    <input id="bank" name="bank" value="{{$order->bank}}" type="text" class="form-control col-md-8">
                                ...
                                <div class="form-group col-md-6 row @if($errors->first('branch') != '') has-error @endif">
                                    ...
                                    <input id="branch" name="branch" value="{{$order->branch}}" type="text" class="form-control col-md-8">
