...
@section('content')
    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">إضافة فئة</h1>
            </div>
        </div>
            ...
            <div class="col-lg-9 col-centered">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body row" style="padding: 40px;">
                        ...
                        <form method="POST" action="{{route('categories.store')}}" enctype="multipart/form-data" role="form" class="col-md-10">
                            ...
                            <div class="form-group row">
                                ...
                                <input name="title" value="{{old('title')}}" placeholder="إسم الفئة" type="text" class="form-control col-md-9">
