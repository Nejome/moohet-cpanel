        ...
        <div class="row">
            ...
            <div class="col-xl-4 order-xl-2 mb-5 mb-xl-0">
                <div class="card card-profile shadow">
                    ...
                    @include('client.customers.change_image_modal')
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            @if($row->user->password != NULL)
                                @include('client.customers.change_password_modal')
                            @else
                                @include('client.customers.add_password_modal')
                            @endif

                            @include('client.customers.phone_verification_modal')
